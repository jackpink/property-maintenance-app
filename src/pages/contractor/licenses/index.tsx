...
type ContractorPageWithUserProps = {
  contractorId: string;
  name: string;
  admin: boolean;
};

const ContractorPageWithUser: React.FC<ContractorPageWithUserProps> = ({
  contractorId,
  name,
  admin,
}) => {
        ...
        <ResponsiveColumns>
          <ColumnOne>
            {contractorIsLoading ? (
              ...
              <>
                <TabListComponent title="About" href={path} selected={false} />
          ...
          <ColumnTwo>
            {contractorIsLoading ? (
              ...
              <>
                <ContractorLicensesSection contractor={contractor} />
              </>
            )}
          </ColumnTwo>
        </ResponsiveColumns>
